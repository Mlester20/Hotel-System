...
<head>
    ...
    <title>@yield('SB Admin 2 - Blank')</title>

    <!-- Preventing to bypass the admin dashboard when not logged in -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('admin')}}">
                ...
                <div class="sidebar-brand-text mx-3 text-sm">Admin</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/logout') }}" onclick="return confirmLogout()">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; MD All Rights Reserve</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- Confirming if the admin want to logout -->
    <script>
